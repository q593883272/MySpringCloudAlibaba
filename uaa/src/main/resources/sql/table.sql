...
(
  --主键
  user_group_id   varchar primary key not null,
  --名称用户组名称
...
(
  ...
  -- 操作内容
  operation_content varchar(32)                        not null default '',
  -- 操作用户
  operation_user    varchar(32)                        not null default '',
  -- 操作时间
...
--   -- 修改人
--   update_user varchar(32)         not null default 'admin',
--   -- 修改时间
--   update_date numeric          not null default (datetime('now', 'localtime')),
--   -- 创建人
--   create_user varchar(32)         not null default 'admin',
--   -- 创建时间
